      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            Welcome to the
            <span className="text-indigo-600 dark:text-indigo-400"> Admin Portal</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
            Manage your platform with our comprehensive admin dashboard. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/register"
              className="border-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors"
            >
              Create Account
            </Link>
          </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Easily manage users, roles, and permissions with our intuitive user management system.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Configure and customize your platform settings with our comprehensive configuration panel.
            </p>
          </div>
        </div>
      </div>
