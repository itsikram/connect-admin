...
export default function AdminSidebar({ sidebarOpen = false, onClose }) {
  ...
  const navigation = [
    ...
    { name: 'Watch', href: '/dashboard/watch', icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z' },
    { name: 'Stories', href: '/dashboard/stories', icon: 'M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm4 0v14m4-10h4m-4 4h4' },
    { name: 'Portfolio', href: '/dashboard/portfolio', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
